...
/**
 * TaskDestinationDown Class Doc Comment
 *
 * @category Class
 * @package  NodeumSDK\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TaskDestinationDown implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'task_destination_down';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'folder' => '\NodeumSDK\Client\Model\NodeumFile',
     ...
     * Sets folder
     *
     * @param \NodeumSDK\Client\Model\NodeumFile|null $folder folder
     *
     * @return $this
     */
