 ...
 * @link     https://openapi-generator.tech
 */
class MountStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mount_status';
    ...
    protected static $openAPITypes = [
        'mounted' => 'bool',
        'message' => 'string',
        'status' => '\NodeumSDK\Client\Model\MountInfo'
    ];
     ...
     * Sets status
     *
     * @param \NodeumSDK\Client\Model\MountInfo|null $status status
     *
     * @return $this
     */
